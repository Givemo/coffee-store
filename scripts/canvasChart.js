...
function drawChart() {
  ...
  if (canvas && canvas.getContext) {
    ...
    createChart(context, coffeeSales, 30, 20, canvas.height - 20, 50);
  }
}

function createChart(context, data, startX, barWidth, chartHeight) {
